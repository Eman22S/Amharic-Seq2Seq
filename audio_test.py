...
# Arguments
def transcript(self,config,filename):

    parser = argparse.ArgumentParser(description='Training E2E asr.')
    parser.add_argument('--config', type=str, default=config, help='Path to experiment config.')
...
res = transcript("config/alffa_example.yaml", 'tr_5792_tr58093.npy')
print(res)